...
|-----------|-------|------|-----------|-------------|
| BenchmarkLogInfo | 92.58 | 0 | 0 | Simple log message |
| BenchmarkLogInfoWithFields | 261.4 | 8 | 1 | Log with 4 structured fields |
| BenchmarkLogLevelFiltering | 5.470 | 0 | 0 | Level filtering (rejected) |
| BenchmarkJSONMarshal | 995.7 | 224 | 6 | JSON serialization |
| BenchmarkRingBuffer | 0.3969 | 0 | 0 | Lock-free ring buffer ops |
| BenchmarkConsoleSink | 5522 | 3,490 | 21 | Console output with batching |
| BenchmarkFileSink | 10161 | 3,490 | 21 | File output with batching |
| BenchmarkAsyncFileSink | 13075 | 3,571 | 22 | Async file output |
| BenchmarkConcurrentLogging | 120.6 | 0 | 0 | Multi-goroutine logging |
